package net.pixl.tutorialmod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.pixl.tutorialmod.TutorialMod;
import net.pixl.tutorialmod.block.custom.AnimatedBlock;
import net.pixl.tutorialmod.item.ModItemGroup;
import net.pixl.tutorialmod.sound.ModSounds;
import net.pixl.tutorialmod.world.tree.RedMapleSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block ANIMATED_BLOCK = Registry.register(Registries.BLOCK, new Identifier(TutorialMod.MOD_ID, "animated_block"),
        new AnimatedBlock(FabricBlockSettings.of(Material.STONE).sounds(ModSounds.ANIMATED_BLOCK_SOUNDS).strength(3.0f).nonOpaque()));
